...
public class PerformanceTest
{
    ...
    public void compressTest() throws IOException
    {
        ...
        manager.encode(stringPerformance10k, new File("Performance10k"));
        ...
        manager.encode(stringPerformance1mil, new File("Performance1mil"));
    ...
    public void decompressTest() throws IOException
    {
        // performance test encode with 10k words
        long startTime10k = System.nanoTime();
        manager.decode(new File("Performance10k"));
        long resultTime10k = System.nanoTime() - startTime10k;
        ...
        // performance test encode with 1mil words
        long startTime1mil = System.nanoTime();
        manager.decode(new File("Performance1mil"));
        long resultTime1mil = System.nanoTime() - startTime1mil;
